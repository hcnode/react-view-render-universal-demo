...
/***/ function(module, exports, __webpack_require__) {
	...
	var Detail = __webpack_require__(168);
	window.DetailComp = ReactDOM.render(React.createElement(Detail, {
	...
	var Index = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				'div',
				null,
				React.createElement(Mode, this.props),
				React.createElement(
					'h2',
					null,
					item.name
				),
				this.state.hideImage ? null : React.createElement('img', { src: item.image }),
				React.createElement(
					'button',
					{ onClick: this.toggleImage },
					this.state.hideImage ? '显示图片' : '隐藏图片'
				)
			);
		}
	});
